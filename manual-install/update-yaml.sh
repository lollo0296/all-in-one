...
sed -i 's|TRUSTED_CACERTS_DIR=|TRUSTED_CACERTS_DIR=/path/to/my/directory          # Nextcloud container will trust all the Certification Authorities, whose certificates are included in the given directory.|' sample.conf
